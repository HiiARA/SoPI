...
echo.
echo 	[2] Multimedia	 	 [5] Rutimes            [8] Acerca de
echo.
...
"%~dp0wget.exe" https://github.com/pintosoft/FocusOnImageViewer/releases/download/1.29/FocusOnIV_1.29.exe --no-check-certificate -O %TMP%\SoPI\FocusOnIV_1.29.exe
cls
echo Instalando espere...
...
"%~dp0wget.exe" https://github.com/pintosoft/FocusOnImageViewer/releases/download/1.29/FocusOnIV64_1.29.exe --no-check-certificate -O %TMP%\SoPI\FocusOnIV64_1.29.exe
cls
echo Instalando espere...
...
if «%processor_architecture%» == «x86» (goto x86) else (goto x64)
:x86
echo Descargando DirectX Redist Repack
...
:x64
echo Descargando DirectX de 64 bits
...
echo [6] Optimizer
echo [7] Wise Program Uninstaller
echo [8] Regresar
echo.
set /p hbz=Opcion: 
if "%hbz%"=="1" goto 7zip
...
"%~dp0wget.exe" https://www.sordum.org/files/download/windows-update-blocker/Wub.zip -O %userprofile%\Desktop\Wub.zip
cls
...
"%~dp0wget.exe" https://github.com/hellzerg/optimizer/releases/download/16.2/Optimizer-16.2.exe -O %userprofile%\Desktop\Optimizer.exe
cls
...
:wpu
cls
echo Descargando Wise Program Uninstaller
"%~dp0wget.exe" https://downloads.wisecleaner.com/soft/WPUSetup_3.1.4.257.exe -O %TMP%\SoPI\WPUSetup_3.1.4.257.exe
cls
echo Instalando espere...
start /wait %TMP%\SoPI\WPUSetup_3.1.4.257.exe /silent
echo Instalado
ping -n 3 localhost>nul
del /f /q %TMP%\SoPI\*.*
cls
